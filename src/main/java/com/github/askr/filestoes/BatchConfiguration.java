...
import com.github.askr.filestoes.config.ESConfig;
import com.github.askr.filestoes.processors.PersonItemProcessor;
import com.github.askr.toes.models.ESDocument;
import com.github.askr.toes.tasklets.AddAliasESTasklet;
import com.github.askr.toes.tasklets.CreateIndexESTasklet;
import com.github.askr.toes.tasklets.DeleteIndexESTasklet;
import com.github.askr.toes.tasklets.PutMappingESTasklet;
import com.github.askr.toes.writers.ESItemWriter;
...
public class BatchConfiguration {
    ...
    @Bean
    public Step step4() {
        return stepBuilderFactory.get("step4").<FileToES, ESDocument> chunk(1000)
                .reader(reader())
                .processor(processor())
                .writer(writer())
                .build();
    ...
    public ItemReader<FileToES> reader() {
        ...
        reader.setLineMapper(new DefaultLineMapper<FileToES>() {{
            ...
            setFieldSetMapper(new BeanWrapperFieldSetMapper<FileToES>() {{
                setTargetType(FileToES.class);
            }});
        }});
        return reader;
    }
     ...
     */
    @Bean
    public ItemProcessor<FileToES, ESDocument> processor() {
